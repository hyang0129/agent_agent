...
| [distributed-worker-management.md](distributed-worker-management.md) | External research survey of how production job queue systems (Sidekiq, Oban, Solid Queue, pg-boss, SQS, BullMQ) handle worker identity, atomic claiming, heartbeat/liveness, crash recovery, eligibility enforcement, concurrency caps, and observability. Reference for P12 design decisions. Keywords: worker, job queue, SKIP LOCKED, heartbeat, staleness, claiming, visibility timeout, idempotency, concurrency, observability. |
